...
ps2poll()
{
    char ch ;
 //   String M[2];
    char* M[2] = {"CQ CQ CQ DE KE4MKG KE4MKG KE4MKG CQ CQ CQ DE KE4MKG KE4MKG KE4MKG K\r\n",
                 "QTH IS LAWRENCEVILLE, GA ? LAWRENCEVILLE, GA\r\n"};
  //  M[1] = "==QTH IS LAWRENCEVILLE, GA ? LAWRENCEVILLE, GA==\r\n";
    int special = 0;                // to indicate if special command is incomming
...
//            queueadd("QTH IS LAWRENCEVILLE, GA ? LAWRENCEVILLE, GA = NAME IS JIM JIM = \r\n") ;

          default:
            Serial.println(" == END MACRO ==");
            special = 0; 
            break; 
